...
export const Filters: React.FC = () => {
	...
	return (
		<div className='flex items-center space-x-1 md:pr-2 md:border-r-2 border-indigo-500 dark:border-slate-100'>
			<span className='font-semibold mr-2'>Filters:</span>
			<Button
				variant='secondary'
				className={cn(
					'px-4 py-1 text-sm font-medium border-2 border-indigo-500 dark:border-slate-400 ',
					{
						'dark:bg-slate-400/20 bg-indigo-500/15  hover:bg-indigo-500/50  dark:hover:bg-slate-400/50':
							!activeFilters.ongoing,
						'bg-indigo-500 dark:bg-slate-400': activeFilters.ongoing,
					}
				)}
			...
			<Button
				...
				className={cn(
					'px-4 py-1 text-sm font-medium border-2 border-indigo-500 dark:border-slate-400',
					{
						'bg-indigo-500 dark:bg-slate-400': activeFilters.expired,
						'dark:bg-slate-400/20 bg-indigo-500/15 hover:bg-indigo-500/50 dark:hover:bg-slate-400/50':
